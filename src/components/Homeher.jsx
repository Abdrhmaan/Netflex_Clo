...
<Link className="rounded bg-[#e50a14] py-2 px-8" to="/login">
    ...
    <main className =  "text-white flex  flex-1  flex-col jus justify-center text-center  items-center  sm:px-24    ">
      <h1 className=' max-w-lg text-5xl font-bold tracking-wider'>Unlimted Movies Tv Show More</h1>
      <h2 className='mt-3 mb-8 text-2xl'>Watch anywhere. Cancel anytime.</h2>
 <p className='text-lg '> 					Ready to watch? Enter your email to create or restart your membership.
 </p>

 <div className='m-4 flex flex-col space-y-4 sm:flex-row sm:space-y-0'>
  <input className='w-full min-w-[400px] bg-white px-24 py-4 text-black outline-none sm:p-4 rounded-sm' type='text'  placeholder='email'/>
